...
${MEMTIER_PATH}/memtier_benchmark -S /tmp/redis.sock --ratio=0:1 --threads=2 --clients=1 --distinct-client-seed -d 384 --key-pattern=R:R --key-maximum=$num_keys --pipeline=128 --hide-histogram -n $num_ops
