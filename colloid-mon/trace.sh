...
addr_local_llc_misses=$(cat /proc/kallsyms | grep smoothed_local_llc_misses | grep nucleus_algorithm | awk '{print "0x"$1}')
addr_remote_llc_misses=$(cat /proc/kallsyms | grep smoothed_remote_llc_misses | grep nucleus_algorithm | awk '{print "0x"$1}')
addr_llc_hits=$(cat /proc/kallsyms | grep smoothed_llc_hits | grep nucleus_algorithm | awk '{print "0x"$1}')
addr_local_llc_hits=$(cat /proc/kallsyms | grep smoothed_local_llc_hits | grep nucleus_algorithm | awk '{print "0x"$1}')
addr_remote_llc_hits=$(cat /proc/kallsyms | grep smoothed_remote_llc_hits | grep nucleus_algorithm | awk '{print "0x"$1}')
